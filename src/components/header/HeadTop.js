    ...
    return(
      <div className='head_box'>
        <div className='contain header_top hidden '>
          {/*--左边--*/}
          <div>
            <span className='blue TOP display'><Link to="/Personal" className='red header_name'>13698224259</Link>：</span>
            <span><Link to="/Index" className='gray'>您好！欢迎来到【聚创医药网--淘药网】-淘！我所药 |</Link></span>
            <a  className='blue TOP display' onClick={(e)=>{this.tuichu(e)}}> 安全退出</a>
          ...
          <ul className='floatRight hidden relative'>
            <li className='cursor'onClick={(e)=>{this.huiyuan(e)}}>会员中心&nbsp;<span>|</span>&nbsp;</li>
            ...
            <li className='marginLeft10  head_rexian cursor'onMouseMove={(e)=>{this.rexian(e)}} onMouseOut={(e)=>{this.rexian1(e)}}>服务热线</li>
            <li className='marginLeft10 head_shoujiban cursor' onMouseMove={(e)=>{this.erweima(e)}} onMouseOut={(e)=>{this.erweima1(e)}}>
            ...
            <div className='shoujiban display'>
              <span className='floatleft marginRight10'><img src={require("../../images/head/btm1.png")} alt=""/>聚创医药网</span>
              <span className='floatleft'><img src={require("../../images/head/btm2.png")} alt=""/>聚创订阅号</span>
            </div>
