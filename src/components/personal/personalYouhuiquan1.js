...
class PersonalYouhuiquan extends React.Component {
    ...
    componentDidMount() {
        ...
        //     type: "post",
        //     data: {
        //         'user_id': user_id, 'token': token, 'user_id': user_id
        //     },
        //     dataType: "json",
        //     success: function (data) {
        //         if (data.data.length == 0) {
    ...
    startAjax() {
        ...
        $.ajax({
            ...
            data: InterfaceUtil.addTime({
                'token': token, 'page': 1, 'user_id': user_id,
            }),
            dataType: "json",
            success: function (data) {
                console.log(data)
            ...
            <div className=' width988 floatRight'>
                ...
                <div className='personal_Dindan_title'>
                    <p className='marginLeft20 fontFamily fontWeight'>
                        优惠券
                        <Link to="/Lingqu"><span
                            className='floatRight personal_Youhuiquan_title_a'>去领取更多优惠券</span></Link>
                        ...
                        <ul>
                            {
                                this.state.yhq.map(function (item) {
                                    ...
                                    return (
                                        <li key={item.index} data={item.is_time} data-index={item.is_use}
                                            data-a={item.type}
                                            ...
                                            <div className='personal_Youhuiquan_title_div1_p' key={item.activity_id}>
                                                ...
                                                <span
                                                    className='personal_Youhuiquan_title_div1_p_span1'>{item.give_more}{item.rebate}</span>
                                                ...
                                                <span
                                                    className='personal_Youhuiquan_title_div1_p_span4'>{item.group_title}可用</span>
                                                <span
