      ...
      <div className=' width988 floatRight'>
        ...
        <div className='white personal_xiangqing_title'>
          ...
          <div className='personal_zhanneixin_top marginTop20 marginLeft20'>
            <p>
              <span className='personal_wodechoucang_top_span marginRight5'><input type="checkbox" className='quanxuan' onClick={(e)=>{this.quanxuan(e)}}/></span>
              ...
              <span className='personal_zhanneixin_top_span5 cursor' onClick={(e)=>{this.quxiaoshoucang(e)}}>取消收藏</span>
            </p>
          </div>
          {/*商品信息*/}
          <table className='personal_Wodejifen_con1_table marginTop20'>
            ...
            <tbody>
            {
              this.state.jylx.map(function (item){
                ...
                return(
            <tr key={item.index} data={item.sp_id} data-index={item.zxdw} data-a={item.id} className='caigou_tr'>
              <td className='orange'>
              ...
              <td>
                <span><img src={require("../../images/personal/lajitong.png")} alt=""
                           onClick={(e)=>{this.quxiaoshoucang1(e)}}/></span>
                <span className='personal_Wodejifen_title_div3_span marginLeft20' onClick={(e)=>{this.buycar4(e)}}>加入购物车</span>
              </td>
            </tr>
                )
              },this )
          ...
          <div className='personal_zhanneixin_top2'>
            <p>
              ...
              <span className='personal_zhanneixin_top_span1 cursor'>全选</span>
              <span className='personal_zhanneixin_top_span4 cursor' onClick={(e)=>this.buycar3(e)}>加入购物车</span>
              <span className='personal_zhanneixin_top_span5 cursor' onClick={()=>this.showConfirm()}>取消收藏</span>
            </p>
          </div>
          {/*分页*/}
          <div className='width988 marginTop20 marginBottom20 paddingBtm20'>
            <span className='floatRight personal_zhanneixin_title_div3_span3'><Pagination showQuickJumper={true}  defaultCurrent={1} defaultPageSize={10} total={this.state.cons} onChange={(e)=>{this.fenye(e)}}  /></span>
            <div className='clear'></div>
          </div>
        </div>
        {/*推荐*/}
