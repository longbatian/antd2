      ...
      <div className=' width988 floatRight'>
        ...
        <div className='marginTop20 bgWhite'>
          ...
          <table className='personal_Jifen_con1_table'>
            <thead>
            <tr>
              <th width="130px">优惠券标识</th>
              <th width="130px">金额</th>
              <th width="170px">使用条件</th>
              <th width="150px">使用范围</th>
              <th width="180px">有效期至</th>
            ...
            <tbody>
              <tr>
                ...
                <td>满600元可使用</td>
                <td>部分商品可使用</td>
                <td>2017-02-02 12:24:24</td>
                <td>
                  <img src={require("../../images/personal/lajitong.png")} alt="" onClick={this.showModal}/>
              ...
              <tr>
                ...
                <td>部分商品可使用</td>
                <td>2017-02-02 12:24:24</td>
                <td><img src={require("../../images/personal/lajitong.png")} alt=""/></td>
              </tr>
              <tr>
                <td>即将过期</td>
                <td>￥30</td>
