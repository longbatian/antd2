      ...
      <div className='contain'>
       <div className='help_div '>
         ...
         <div className='help_div_div1'>
           <img src={require("../../images/helpZx/sanjiao.png")} className='marginRight10 marginTop3' alt=""/>{item.names}
         </div>
         ...
         <ul className='help_div_ul'>
           {
             this.state.title[i].res.map(function (item,i){
               return(
           <li data={item.id} data-index={item.pid} onClick={(e)=>{this.bangzhu(e)}} className='help_div_ul_li'>
             <Link to={'?&id='+item.id}>
               {item.title}
             </Link>
