...
class Dingdan extends React.Component{
    ...
    render(){
        ...
        let imgs=this.state.imgs?<img className="payImgs" src={this.state.imgs}/>:null;
        return(
           ...
           {this.state.chuangjian.orderno}</span></p>
                    ...
                    <p className='marginLeft20'><span className='dingdan_div_p_span'>应付金额：</span><span  className='red'>￥{this.state.chuangjian.ddsfje}</span></p>
                    ...
                    <p className='marginLeft20'>
                        ...
                        <span className='dingdan_div_p_span1 marginLeft20 dingdan_div_p_span3' onClick={(e)=>{this.zhifu(e)}}>
             <img src={require("../../images/buycar/zfb.png")} className='marginRight10 dingdan_div_p_span1_img' alt=""/>支付宝</span>
                       <span className='dingdan_div_p_span2 marginLeft20' onClick={(e)=>{this.zhifu1(e)}}>
             <img src={require("../../images/buycar/weixin.png")} className='marginRight10 dingdan_div_p_span1_img' alt=""/>微信支付</span>
                    </p>
           ...
           >立即支付</span>
                ...
                <p className='contain marginTop20 marginBottom10'>返回 <Link to="/Index"><span className='dingdan_p_span'>首页</span></Link> 或者返回 <Link to="/Chanpinzhongxin"><span className='dingdan_p_span'>会员中心</span></Link></p>
            </div>
        )
    }
    componentDidUpdate(){
