...
class Shangpinxiangqing extends React.Component {
    ...
    //     var he = 0;
    //     if (b == 'eee') {
    //         a.parentNode.className = ' shangpinxiangqing_sp_dadang_con_img_gou shangpinxiangqing_sp_dadang_con_img_gou_current';
    //         a.className = 'aaa';
    //         var length = $('.aaa').length;
    //         if (this.state.length == 2) {
    //             for (var i = 0; i < length; i++) {
    //                 var zhi = $('.aaa').eq(i).parent().parent().find('div:first-child');
    //                 var jiage = zhi.attr('data-index');
    //                 var shuliang = zhi.attr('value');
    //                 jiage = parseFloat(jiage)
    //                 shuliang = parseFloat(shuliang)
    //                 he = he + jiage * shuliang;
    //                 var c = he.toFixed(2);
    //                 $('.zongjia').text('总价：' + c);
    //             }
    //         } else {
    //             for (var i = 0; i < length; i++) {
    //                 var zhi = $('.aaa').eq(i).parent().parent().find('.orange span').text();
    //                 var shu = $('.aaa').eq(i).parent().parent().find('.orange').prev().find('span').text();
    //                 var zongjia = $('.aaa').parent().parent().parent().children('div:last-child').find('.zongjia');
    //                 zhi = parseFloat(zhi)
    //                 shu = parseFloat(shu)
    //
    //                 he = he + zhi * shu;
    ...
    //     }
    //     else if (b == 'aaa') {
    //         a.parentNode.className = ' shangpinxiangqing_sp_dadang_con_img_gou ';
    //         a.className = 'eee';
    //         var length = $('.aaa').length;
    //         if (this.state.length == 2) {
    //             for (var i = 0; i < length; i++) {
