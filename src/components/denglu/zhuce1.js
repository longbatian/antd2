                ...
                <div className='contain'>
                  ...
                  {this.state.tishiUser.dwmcT}
                        ...
                        <div className='zhuce_con_form_p'>
                            ...
                            <input type="text" name='lxr' value={this.state.lxr}
                                   onChange={this.handleChange.bind(this, 'lxr')}
                        ...
                        <div className='zhuce_con_form_p'>
                            ...
                            <input type="text" name='lxdh' value={this.state.lxdh}
                                   onChange={this.handleChange.bind(this, 'lxdh')}
                        ...
                        <div className='zhuce_con_form_p'>
                            ...
                            <input type="text" name='yx' value={this.state.yx}
                                   onChange={this.handleChange.bind(this, 'yx')}
                        ...
                        <div className='zhuce_con_form_p'>
                            ...
                            <input type="text" name='qq' value={this.state.qq}
                        ...
                        <div className='zhuce_con_form_p'>
                            ...
                            <input type="text" name='tjr' value={this.state.tjr}
                                   onChange={this.handleChange.bind(this, 'tjr')}
                    ...
                    <div className='floatleft zhuce_con_you'>
                        <p>已有账号?请直接登录 <Link to="/Denglu" className='black'><span className='zhuce_con_you_btn'>登录</span></Link>
                        </p>
