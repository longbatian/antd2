      ...
      <div className='container bgWhite'>
                ...
                <div className='denglu_con_kuang relative'>
                  <div className='denglu_con_kuang_box'>
                    ...
                    <p className='denglu_con_kuang_box_p3'>
                      <span className='denglu_con_kuang_box_p3_span'><input type="checkbox" className='denglu_con_kuang_box_p3_mima' /> 记住密码</span>
                      <span className=''><Link to="/Zhuce"  className='denglu_con_kuang_box_p3_span1'>快速注册</Link></span>
                      <span className='clear'></span>
                    </p>
                    <p className='denglu_con_kuang_box_p4'>
                      <button className='denglu_con_kuang_box_btn'onClick={()=>this.post()}>登录</button>
                    </p>
                    <p className='denglu_con_kuang_box_p5'>
                      <span className='denglu_con_kuang_box_p5_span'>忘记密码？</span>
                      <Link to="/Zhaohui"><span className='denglu_con_kuang_box_p5_span1'>找回密码</span></Link>
                    </p>
                    ...
                    <img src={require("../../images/denglu/erweima.png")} alt="" className='denglu_con_img1'
                         onClick={(e)=>{this.qiehuan(e)}}/>
                  </div>


                  <div className='denglu_con_kuang_box display'>
                    <p className='denglu_con_kuang_box_p'>扫码登录</p>
                    <p className='denglu_con_kuang_box_img'><img src="../../images/denglu/erweima1.png" alt=""/></p>
                    ...
                    <p className='marginTop20 denglu_con_kuang_box_p7'>
                      ...
                      <span onClick={(e)=>{this.qiehuan2(e)}} className='floatRight denglu_con_kuang_box_p7_span'>账号登录</span>
                    </p>
                    <img src={require("../../images/denglu/zhanghao.png")} alt="" className='denglu_con_img'/>
                    <img src={require("../../images/denglu/diannao.png")} alt="" className='denglu_con_img1'
                         onClick={(e)=>{this.qiehuan1(e)}} />
                  </div>
          ...
          <div className='contain'>
            <ul className='denglu_footer_ul'>
              ...
              <Link to="/Zhaohui"> <li className='denglu_footer_ul_li3'>
