    ...
    zhaohui(e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                alert(data.msg)
                if (data.code === 1) that.props.history.push('/Denglu');
            }
        });
        ...
        return (
            <div className='container bgWhite'>
                        ...
                        <div className='zhaohui_bg_div'>
                            ...
                            <div>
                                ...
                                <p className='zhaohui_div_p'>
                                    <span className='zhaohui_div_p_span' onClick={(e) => {
                                        this.zhaohui(e)
                                    }}>找回密码</span>
                                </p>
                            </div>
                ...
                <div className='container zhaohui_bg1'>
                    <div className='contain '>
                        <p className='center zhaohui_banquan1'>《互联网药品信息服务资格证》证书号：（川）-非经营性2015-0039 |《互联网药品交易服务资格证》
